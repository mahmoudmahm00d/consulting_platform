...
@section('content')
    ...
    <form action="/categories" method="post" enctype="multipart/form-data" class="col-md-6 needs-validation" novalidate>
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" accept=".jpg, .png" name="image" id="image"/>
            @error('image')
